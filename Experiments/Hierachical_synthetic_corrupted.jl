...
@load "Synthetic_data_v2_M$M.jld2" X_synth_corrupted
...
n = 10000
Rtrial = 20
ABCHybridSMC(log_hyper_prior,sample_hyper_prior,log_q,q,hyper_model,discrepancy,X_synth_corrupted,n,Rtrial,c,pmin,a,"results_par/Hierachical_synth_corrupted_M$M")
