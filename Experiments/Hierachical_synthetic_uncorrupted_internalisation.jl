...
@load "Synthetic_data_v2.jld2" X_synth_uncorrupted
...
n = 1000
Rtrial = 20
ABCHybridSMC(log_hyper_prior,sample_hyper_prior,log_q,q,hyper_model,discrepancy,X_synth_uncorrupted,n,Rtrial,c,pmin,a,"results_par/Hierachical_synth_uncorrupted_internalisation")
