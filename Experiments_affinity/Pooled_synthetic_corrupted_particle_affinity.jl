...
prior_dist = product_distribution(
     Uniform(0.0,2e-6),     # 1. σr
     Uniform(0.0,5.0),    # 2. σK
...
@load "Synthetic_data_particle_affinity_v3_pooled_M$M.jld2" X_synth_corrupted Dcell Dparticle
...
Rtrial = 50
a = 0.5
ABCHybridSMC(log_prior,sample_prior,log_q,q,model,discrepancy,flatten_X_synth_corrupted,n,Rtrial,c,pmin,a,"results_par2/Pooled_v2_synth_corrupted_particle_affinity_M$M")
