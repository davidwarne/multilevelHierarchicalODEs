...
@load "Synthetic_data_particle_affinity_v3_pooled_M$M.jld2" X_synth_uncorrupted Dcell Dparticle
...
Rtrial = 50
a = 0.5
ABCHybridSMC(log_prior,sample_prior,log_q,q,model,discrepancy,flatten_X_synth_uncorrupted,n,Rtrial,c,pmin,a,"results_par/Pooled_v2_synth_uncorrupted_particle_affinity_M$M")
