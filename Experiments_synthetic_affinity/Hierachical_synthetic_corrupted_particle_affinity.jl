...
@load "Synthetic_data_particle_affinity_v3_M$M.jld2" X_synth_corrupted Dcell Dparticle
...
Rtrial = 50
a = 0.5
ABCHybridSMC(log_hyper_prior,sample_hyper_prior,log_q,q,hyper_model,discrepancy,X_synth_corrupted,n,Rtrial,c,pmin,a,"results_par/Hierachical_synth_corrupted_particle_affinity_M$M")
